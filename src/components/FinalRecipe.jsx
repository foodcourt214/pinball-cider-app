            ...
            <div className="space-y-2">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="flex-1 text-xs bg-slate-700 hover:bg-slate-600 text-slate-300 px-2 py-1.5 rounded">
                  Replace
                </button>
                <button
                  onClick={() => setFinalRecipe(r => ({ ...r, screenshot: null }))}
                  className="text-xs bg-slate-700 hover:bg-red-500 hover:text-white text-slate-400 px-2 py-1.5 rounded">
                  Remove
                </button>
              </div>
            </div>
